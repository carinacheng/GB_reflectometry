...
systematic effects in measured data. One such source is the mismatch
...
incident signal at the feed. This specification was approximated based on the estimated power level of the cosmological signal in relation to foreground signals, as well as the $14m$ baselines of HERA dishes.

We carry out reflectometry measurements at the HERA antenna prototype in Green Bank, WV in order to understand the nature of antenna reflections in the dish and characterize its performance. As HERA
