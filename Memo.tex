...
the impedance of free space and the antenna and transmission line, which
results in a partial coupling of the sky signal into the antenna while the rest
is reflected back into the space. For any reflector antenna, such as the HERA
...
signal at the feed. This specification was approximated based on the estimated
power level of the cosmological signal in relation to foreground signals, as
well as the $14m$ baselines of HERA dishes.

We carry out reflectometry measurements at the HERA antenna prototype in Green
Bank, WV in order to understand the nature of antenna reflections in the dish
