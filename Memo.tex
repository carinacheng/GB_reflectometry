...
Reflections cause an input signal to have ripples of various frequencies over
its passband, which manifest themselves as non-zero signals at various delays
in the delay domain. We aim to measure the relative signal strength at various
delays, referred to as the ``delay spectrum" hereafter, to estimate various
levels of reflections in between the feed and the dish apex.
