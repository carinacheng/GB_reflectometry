...
The reflectometry measurements used the prototype HERA dish (Figure
...
reflective material is made up of $1\,cm$ wire mesh that is attached to PVC
pipes that form the parabolic shape of the dish. With the current iteration of
...
The measurements were made with a FieldFox in VNA mode. In this mode, a pulse,
...
is $9\,m$, which correspinds to a delay of $30\,ns$.
...
delays due to the sidelobes of the $sinc$ function. To minimize the sidelobes we
 need to use an appropriate window function before taking the Fourier transform.
We have chosen a Hamming [XXX] window in measuremnts. The effectiveness of this
window function compared to a square windoe function is illustrated in Figure
\ref{fig:window}.
